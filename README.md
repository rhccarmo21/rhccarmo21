...
- 🔹 **Nível 1 — Fundamentos e Análise Exploratória**: `educational-indicators-br`, `eja-enrollment-decline`, `acesso-servicos-basicos`  
- 🔸 **Nível 2 — Modelagem Supervisionada e Dashboards**: `fiscal-scenario-simulator`, `health-system-diagnosis`  
- 🔶 **Nível 3 — Séries Temporais e Modelos Tradicionais**: `municipal-spending-comparator`, `urban-inequality-analysis`  
- ⚪ **Nível 4 — Inferência Causal e Modelos Explicáveis**: `avaliacao-politicas-publicas`, `public-policy-causal-impact`, `credit-risk-xai`  
- 🟣 **Nível 5 — Machine Learning Moderno e MLOps**: `mlops-model-pipeline`, `environmental-risk-mapping`  
